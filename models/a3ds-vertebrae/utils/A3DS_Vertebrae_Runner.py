"""
-------------------------------------------------
MHub - run the Auto3dSeg pipeline
-------------------------------------------------
...
based on lungmask example from Dennis Bontempi
-------------------------------------------------
"""
...
class A3DS_Vertebrae_Runner(ModelRunner):
    ...
    def model_inference(self,model_file,
        ...
        # the original model used nrrd, but we are using nifti because the
        # nifti environment is more mature in MHub.ai at this time
